    ...
    setupHandlers() {
        ...
        this.activityProc.invokeActivityHandler = {
            onMessagingExtensionQuery: (ctx, query) => __awaiter(this, void 0, void 0, function* () {
                let preview = botbuilder_1.CardFactory.thumbnailCard('Search Item Card', 'This is to show the search result');
                let heroCard = botbuilder_1.CardFactory.heroCard('Result Card', '<pre>This card mocks the CE results</pre>');
                let response = {
                    status: 200,
                    body: {
                        composeExtension: {

    ...
    setupHandlers() {
        ...
        this.activityProc.invokeActivityHandler = {
            onMessagingExtensionQuery: (ctx, query) => __awaiter(this, void 0, void 0, function* () {
                let preview = botbuilder_1.CardFactory.thumbnailCard('VENIAM', "Qui et deserunt minim qui in.", ["http://placehold.it/32x32"]);
                let preview2 = botbuilder_1.CardFactory.thumbnailCard('OCCAECAT', "Voluptate excepteur cupidatat laborum velit.", ["http://placehold.it/32x32"]);
                let preview3 = botbuilder_1.CardFactory.thumbnailCard('ALIQUA', "Consequat voluptate elit minim aliquip.", ["http://placehold.it/32x32"]);
                    ...
                    body: {
                        composeExtension: {
                            ...
                            attachments: [
                                ...
                                Object.assign({}, heroCard, { preview: preview2 }),
                                Object.assign({}, heroCard, { preview: preview3 })
                            ]
                        }
                    }
                };
